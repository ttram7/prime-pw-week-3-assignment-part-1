...
let faveFoods = ['BBQ', 'hotpot', 'seafood', 'pasta', 'burger', 'sushi'];

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above
console.log('Favorite foods are: ', faveFoods);
...
console.log('Number of favorite foods:', faveFoods.length);
...
faveFoods.push('ramen');
console.log('Added a food item to end', faveFoods);
...
faveFoods.unshift('potatoes');
console.log(`Added a food item to beginning: ${faveFoods}`);
